      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[4rem] items-center">
        ...
        <div className="order-1 lg:order-2">
          <h1
            ...
            data-aos-anchor-placement="top-center"
            data-aos-delay="200"
            className="text-[20px] md:text-[25px] text-[#02073e] font-bold leading-[2rem] md:leading-[3rem]"
          >
          ...
          >
            ...
            blanditiis vel eos ipsum provident incidunt, laboriosam dolore totam
            inventore fugit!
          </p>
          <div
            data-aos="fade-up"
