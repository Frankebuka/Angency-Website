      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 items-center w-[80%] mx-auto">
        <div className="col-span-2">
          ...
          >
            ...
            eligendi aliquam. Dolorem accusamus recusandae quaerat, officia
            maxime delectus facilis optio magnam cum dolorum ad nam dignissimos
            atque amet. Fuga, aspernatur.
          </p>
          <div
            data-aos="zoom-in"
            data-aos-delay="400"
